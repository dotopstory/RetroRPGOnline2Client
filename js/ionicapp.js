...
.controller('AppCtrl', function($scope, $ionicPlatform, $ionicLoading, $ionicPopup) {
  ...
  // var productIds = ['gold100']; // <- Add your product Ids here

  var spinner = '<ion-spinner icon="dots" class="spinner-stable"></ion-spinner><br/>';

  $scope.loadProducts = function () {
  	 //alert(JSON.stringify(game.products));
    $ionicLoading.show({ template: spinner + 'Loading Products...' });
    inAppPurchase
      .getProducts(game.products)
  ...
  $scope.buy = function (productId) {
    ...
    inAppPurchase
      ...
      .then(function (data) {
        ...
        game.client.sendPurchase(data.productId, receipt.purchaseToken);
  ...
  $scope.test = function () {
  	game.client.sendPurchase('gold10000', '1234');  
  };
