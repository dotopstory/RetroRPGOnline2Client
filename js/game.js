        ...
        var Game = Class.extend({
            ...
            removeEntity: function(entity) {
                if(entity.id in this.entities && !(entity instanceof House)) {
                    ...
                    this.updateCameraEntity(entity.id, null);
                }
                else {
		    ...
		    self.resetCamera();
                    ...
                    self.player.onStep(function() {
                        ...
                        if (self.usejoysitck && (self.joystick.isActive()))
                        {
				...
				/*for (var i=0; i < self.player.pets.length; ++i)
				{
                    ...
                    self.player.onDeath(function() {
                        ...
                        self.player.animate("death", 256, 1, function() {
                            ...
                            self.updateCameraEntity(self.player.id, self.player);
                            //self.player = null;
                            //self.client.disable();
                    ...
                    self.client.onEntityMove(async function(map, id, x, y, o, targetid, date) {
                        var entity = null;
                ...
                if(!this.hoveringCollidingTile && !this.hoveringPlateauTile) {
                    	    ...
                    	    this.map.index > 0))
                    {
                        ...
                        if (!this.player.hasTarget() || (this.player.target && entity !== this.player.target))
						{
							...
							if (!this.player.isAdjacentNonDiagonal(this.player.target) && !this.player.getDistanceToEntity(this.player.target) == 0)
